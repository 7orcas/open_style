  ...
  this.modes = [
    {
      ...
      getVisibleDates: function(date, selected) {
        ...
        //CHANGE 1 Customerized 08.07.14
        labels = getCustomerizedShortDaysOfTheWeek();
  ...
  return {
    ...
    link: function(scope, element, attrs, ctrls) {
      ...
      function refill( updateSelected ) {
        ...
        //CHANGE 1 Customerized 08.07.14
        scope.title = getCustomerizedMonthsOfTheYear(data.title);
      }
  ...
  return {
    ...
    link: function(originalScope, element, attrs, ngModel) {
      ...
      attrs.$observe('currentText', function(text) {
        scope.currentText = angular.isDefined(text) ? text : getCustomerizedLanguageLabel(datepickerPopupConfig.currentText); //CHANGE 1 Customerized 17.11.14
      });
      attrs.$observe('toggleWeeksText', function(text) {
        scope.toggleWeeksText = angular.isDefined(text) ? text : getCustomerizedLanguageLabel(datepickerPopupConfig.toggleWeeksText); //CHANGE 1 Customerized 17.11.14
      });
      attrs.$observe('clearText', function(text) {
        scope.clearText = angular.isDefined(text) ? text : getCustomerizedLanguageLabel(datepickerPopupConfig.clearText); //CHANGE 1 Customerized 17.11.14
      });
      attrs.$observe('closeText', function(text) {
        scope.closeText = angular.isDefined(text) ? text : getCustomerizedLanguageLabel(datepickerPopupConfig.closeText); //CHANGE 1 Customerized 17.11.14
      });
      ...
      scope.clear = function() {
    	scope.dateSelection(new Date());  //CHANGE 3 added this line (makes it work)
    ...
    link:function (originalScope, element, attrs, modelCtrl) {
      ...
      element.bind('keydown', function (evt) {
        ...
        if (evt.which === 40) {
          ...
          //CHANGE 2 see comments at top
          if (scope.matches[scope.activeIdx].label.indexOf('...+') !== -1){
              scope.activeIdx -= 1;
          }
          scope.$digest();
